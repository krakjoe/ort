...
try {
    $tensor = new ORT\Tensor\Transient([2, 3], [[1, 2, 3], [4, 5, 6]], ORT\Tensor::FLOAT32);
    $scalar = new ORT\Tensor\Transient([], [10], ORT\Tensor::FLOAT32);
...
try {
    ...
    $vector = new ORT\Tensor\Transient([3], [1, 1, 1], ORT\Tensor::FLOAT32);
...
try {
    ...
    $tensor_b = new ORT\Tensor\Transient([2, 4], [[1, 2, 3, 4], [5, 6, 7, 8]], ORT\Tensor::FLOAT32);
...
try {
    ...
    $tensor_2d = new ORT\Tensor\Transient([2, 2], [[1, 1], [1, 1]], ORT\Tensor::FLOAT32);
...
try {
    $single_a = new ORT\Tensor\Transient([1, 1], [[5]], ORT\Tensor::FLOAT32);
    $single_b = new ORT\Tensor\Transient([1, 1], [[3]], ORT\Tensor::FLOAT32);
