...
try {
    $tensor_a3 = new ORT\Tensor\Transient([2], [1, 2], ORT\Tensor::INT32);
    $tensor_b3 = new ORT\Tensor\Transient([2], [3, 4], ORT\Tensor::INT32);
...
try {
    $tensor_a4 = new ORT\Tensor\Transient([2], [1, 2], ORT\Tensor::INT16);
    $tensor_b4 = new ORT\Tensor\Transient([2], [3, 4], ORT\Tensor::INT32);
    $result = ORT\Math\add($tensor_a4, $tensor_b4);
...
try {
    $tensor_a5 = new ORT\Tensor\Transient([2], [true, false], ORT\Tensor::BOOL);
    $tensor_b5 = new ORT\Tensor\Transient([2], [1, 2], ORT\Tensor::INT32);
    $result = ORT\Math\add($tensor_a5, $tensor_b5);
...
try {
    ...
    $tensor_a6 = new ORT\Tensor\Transient([2], [1, 2], ORT\Tensor::UINT8);
    $tensor_b6 = new ORT\Tensor\Transient([2], [3, 4], ORT\Tensor::UINT32);
    $result = ORT\Math\add($tensor_a6, $tensor_b6);
