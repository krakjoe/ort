...
?>
--EXPECTF--
PASS: FLOAT divide tensor + scalar (-7)
RESULT: %s
TYPE: FLOAT
SHAPE: [33]
PASS: FLOAT divide tensor + scalar (-3)
RESULT: %s
TYPE: FLOAT
SHAPE: [33]
PASS: FLOAT divide tensor + scalar (-1)
RESULT: %s
TYPE: FLOAT
SHAPE: [33]
PASS: FLOAT divide tensor + scalar (1)
...
TYPE: FLOAT
SHAPE: [33]
PASS: DOUBLE divide tensor + scalar (-7)
RESULT: %s
TYPE: DOUBLE
SHAPE: [33]
PASS: DOUBLE divide tensor + scalar (-3)
RESULT: %s
TYPE: DOUBLE
SHAPE: [33]
PASS: DOUBLE divide tensor + scalar (-1)
RESULT: %s
TYPE: DOUBLE
SHAPE: [33]
PASS: DOUBLE divide tensor + scalar (1)
