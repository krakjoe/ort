--TEST--
ONNX\Math\log2: line-by-line, all types, shape, error handling, numpy semantics
--EXTENSIONS--
ort
--FILE--
<?php
...
?>
--EXPECTF--
PASS: FLOAT log2 large signed [-16..-1,0,1..16]
RESULT: %s
TYPE: FLOAT
SHAPE: [33]
PASS: DOUBLE log2 large signed [-16..-1,0,1..16]
RESULT: %s
TYPE: DOUBLE
SHAPE: [33]
...
TYPE: DOUBLE
SHAPE: [32]
PASS: FLOAT log2 large zeros/ones
RESULT: %s
TYPE: FLOAT
SHAPE: [32]
PASS: DOUBLE log2 large zeros/ones
RESULT: %s
TYPE: DOUBLE
SHAPE: [32]
...
TYPE: FLOAT
SHAPE: [8,8]
PASS: FLOAT log2 extremes large
RESULT: %s
TYPE: FLOAT
SHAPE: [36]
PASS: DOUBLE log2 extremes large
RESULT: %s
TYPE: DOUBLE
SHAPE: [36]
