--TEST--
ORT\Math\tanh: line-by-line, all types, shape, error handling, numpy semantics
--FILE--
<?php
use ORT\Tensor;
...
?>
--EXPECTF--
PASS: FLOAT16 tanh large signed [-16..-1,0,1..16]
RESULT: %s
TYPE: FLOAT16
SHAPE: [33]
PASS: FLOAT32 tanh large signed [-16..-1,0,1..16]
RESULT: %s
TYPE: FLOAT32
SHAPE: [33]
PASS: FLOAT64 tanh large signed [-16..-1,0,1..16]
RESULT: %s
TYPE: FLOAT64
SHAPE: [33]
...
TYPE: FLOAT64
SHAPE: [32]
PASS: FLOAT16 tanh large zeros/ones
RESULT: %s
TYPE: FLOAT16
SHAPE: [32]
PASS: FLOAT32 tanh large zeros/ones
RESULT: %s
TYPE: FLOAT32
SHAPE: [32]
PASS: FLOAT64 tanh large zeros/ones
RESULT: %s
TYPE: FLOAT64
SHAPE: [32]
...
TYPE: FLOAT16
SHAPE: [8,8]
PASS: FLOAT16 tanh extremes large
RESULT: %s
TYPE: FLOAT16
SHAPE: [36]
PASS: FLOAT32 tanh extremes large
RESULT: %s
TYPE: FLOAT32
SHAPE: [36]
PASS: FLOAT64 tanh extremes large
RESULT: %s
TYPE: FLOAT64
SHAPE: [36]
