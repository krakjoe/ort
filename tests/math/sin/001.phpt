--TEST--
ONNX\Math\sin: line-by-line, all types, shape, error handling, numpy semantics
--FILE--
<?php
use ONNX\Tensor;
...
--EXPECTF--
PASS: FLOAT sin large signed [-16..-1,0,1..16]
RESULT: %s
TYPE: FLOAT
SHAPE: [33]
PASS: DOUBLE sin large signed [-16..-1,0,1..16]
RESULT: %s
TYPE: DOUBLE
SHAPE: [33]
...
TYPE: DOUBLE
SHAPE: [32]
PASS: FLOAT sin large zeros/ones
RESULT: %s
TYPE: FLOAT
SHAPE: [32]
PASS: DOUBLE sin large zeros/ones
RESULT: %s
TYPE: DOUBLE
SHAPE: [32]
...
TYPE: FLOAT
SHAPE: [36]
PASS: DOUBLE sin extremes large
RESULT: %s
TYPE: DOUBLE
SHAPE: [36]
