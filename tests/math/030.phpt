...
try {
    $tensor_a = new ORT\Tensor\Transient([3], [24, 16, 8], ORT\Tensor::INT8);
    $tensor_b = new ORT\Tensor\Transient([3], [3, 2, 4], ORT\Tensor::INT8);
...
try {
    $tensor_a = new ORT\Tensor\Transient([3], [1000, 2000, 3000], ORT\Tensor::INT16);
    $tensor_b = new ORT\Tensor\Transient([3], [10, 20, 30], ORT\Tensor::INT16);
    $result = ORT\Math\divide($tensor_a, $tensor_b);
    $data = $result->getData();
...
try {
    $tensor_a = new ORT\Tensor\Transient([3], [100000, 200000, 300000], ORT\Tensor::INT32);
    $tensor_b = new ORT\Tensor\Transient([3], [1000, 2000, 3000], ORT\Tensor::INT32);
    $result = ORT\Math\divide($tensor_a, $tensor_b);
    $data = $result->getData();
    if ($data[0] == 100 && $data[1] == 100 && $data[2] == 100) {
...
try {
    $tensor_a = new ORT\Tensor\Transient([3], [1000000000, 2000000000, 3000000000], ORT\Tensor::INT64);
    $tensor_b = new ORT\Tensor\Transient([3], [10000000, 20000000, 30000000], ORT\Tensor::INT64);
    $result = ORT\Math\divide($tensor_a, $tensor_b);
    $data = $result->getData();
    if ($data[0] == 100 && $data[1] == 100 && $data[2] == 100) {
...
try {
    $tensor_a = new ORT\Tensor\Transient([3], [240, 160, 80], ORT\Tensor::UINT8);
    $tensor_b = new ORT\Tensor\Transient([3], [3, 2, 4], ORT\Tensor::UINT8);
    $result = ORT\Math\divide($tensor_a, $tensor_b);
    $data = $result->getData();
...
try {
    $tensor_a = new ORT\Tensor\Transient([3], [10000, 20000, 30000], ORT\Tensor::UINT16);
    $tensor_b = new ORT\Tensor\Transient([3], [100, 200, 300], ORT\Tensor::UINT16);
    $result = ORT\Math\divide($tensor_a, $tensor_b);
    $data = $result->getData();
    if ($data[0] == 100 && $data[1] == 100 && $data[2] == 100) {
...
try {
    $tensor_a = new ORT\Tensor\Transient([3], [1000000, 2000000, 3000000], ORT\Tensor::UINT32);
    $tensor_b = new ORT\Tensor\Transient([3], [10000, 20000, 30000], ORT\Tensor::UINT32);
    $result = ORT\Math\divide($tensor_a, $tensor_b);
    $data = $result->getData();
    if ($data[0] == 100 && $data[1] == 100 && $data[2] == 100) {
