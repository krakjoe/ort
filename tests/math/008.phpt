...
try {
    $tensor_a1 = new ONNX\Tensor\Transient([2, 3], [[1, 2, 3], [4, 5, 6]], ONNX\Tensor::FLOAT);
    $tensor_b1 = new ONNX\Tensor\Transient([2, 3], [[1, 1, 1], [2, 2, 2]], ONNX\Tensor::FLOAT);
...
try {
    $tensor_a2 = new ONNX\Tensor\Transient([2, 3], [[1, 2, 3], [4, 5, 6]], ONNX\Tensor::FLOAT);
    $tensor_b2 = new ONNX\Tensor\Transient([3, 2], [[1, 2], [3, 4], [5, 6]], ONNX\Tensor::FLOAT);
...
try {
    $tensor_a3 = new ONNX\Tensor\Transient([6], [1, 2, 3, 4, 5, 6], ONNX\Tensor::FLOAT);
    $tensor_b3 = new ONNX\Tensor\Transient([2, 3], [[1, 1, 1], [2, 2, 2]], ONNX\Tensor::FLOAT);
