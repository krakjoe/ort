--TEST--
ORT\Math\reduce\axis\mean: all types, axis, keepdims, negative axis, and error handling
--EXTENSIONS--
ort
--FILE--
<?php
...
foreach ($types as $name => $type) {
    ...
    try {
        $result = ORT\Math\reduce\axis\mean($a, 0);
...
foreach ($types as $name => $type) {
    ...
    try {
        $result = ORT\Math\reduce\axis\mean($a, 1);
...
foreach ($types as $name => $type) {
    ...
    try {
        $result = ORT\Math\reduce\axis\mean($a, 1, true);
...
try {
    ...
    $result = ORT\Math\reduce\axis\mean($a, 'foo');
...
try {
    ...
    $result = ORT\Math\reduce\axis\mean($a, 2);
...
?>
--EXPECTF--
PASS: FLOAT16 mean axis=0
RESULT: [2.5,3.5,4.5]
TYPE: FLOAT16
SHAPE: [3]
PASS: FLOAT32 mean axis=0
RESULT: [2.5,3.5,4.5]
TYPE: FLOAT32
SHAPE: [3]
PASS: FLOAT64 mean axis=0
RESULT: [2.5,3.5,4.5]
TYPE: FLOAT64
SHAPE: [3]
...
TYPE: FLOAT64
SHAPE: [3]
PASS: FLOAT16 mean axis=1
RESULT: [2,5]
TYPE: FLOAT16
SHAPE: [2]
PASS: FLOAT32 mean axis=1
RESULT: [2,5]
TYPE: FLOAT32
SHAPE: [2]
PASS: FLOAT64 mean axis=1
RESULT: [2,5]
TYPE: FLOAT64
SHAPE: [2]
...
TYPE: FLOAT64
SHAPE: [2]
PASS: FLOAT16 mean axis=1 keepdims
RESULT: [[2],[5]]
TYPE: FLOAT16
SHAPE: [2,1]
PASS: FLOAT32 mean axis=1 keepdims
RESULT: [[2],[5]]
TYPE: FLOAT32
SHAPE: [2,1]
PASS: FLOAT64 mean axis=1 keepdims
RESULT: [[2],[5]]
TYPE: FLOAT64
SHAPE: [2,1]
