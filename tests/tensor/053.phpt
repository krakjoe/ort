...
// Test INT8 tensor
$int8_tensor = new ORT\Tensor\Persistent(
    "int8_tensor",
    [2],
    [127, -128],
    ORT\Tensor::INT8
...
// Test UINT16 tensor  
$uint16_tensor = new ORT\Tensor\Persistent(
    "uint16_tensor",
    [3],
    [0, 32767, 65535],
    ORT\Tensor::UINT16
...
// Test DOUBLE tensor
$double_tensor = new ORT\Tensor\Persistent(
    "double_tensor",
    [1, 2],
...
$tensor_4d = new ORT\Tensor\Persistent(
    "tensor_4d",
    [1, 2, 2, 1],
    [[[[1], [2]], [[3], [4]]]],
    ORT\Tensor::UINT32
