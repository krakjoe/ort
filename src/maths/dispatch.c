...
static ort_math_dispatch_t __ort_math_dispatch_table[] = {
    ...
    /* INT8 */
    {
        ...
        .round_func      = NULL,
        .abs_func        = NULL,
        .sqrt_func       = ort_math_frontend_sqrt_int8_t,
        ...
        .sum_func        = ort_math_frontend_sum_int8_t,
        .sum_axis_func   = ort_math_frontend_sum_axis_int8_t,
    ...
    /* INT16 */
    {
        ...
        .round_func      = NULL,
        .abs_func        = NULL,
        .sqrt_func       = ort_math_frontend_sqrt_int16_t,
        ...
        .sum_func        = ort_math_frontend_sum_int16_t,
        .sum_axis_func   = ort_math_frontend_sum_axis_int16_t,
    ...
    /* INT32 */
    {
        ...
        .round_func      = NULL,
        .abs_func        = NULL,
        .sqrt_func       = ort_math_frontend_sqrt_int32_t,
        ...
        .sum_func        = ort_math_frontend_sum_int32_t,
        .sum_axis_func   = ort_math_frontend_sum_axis_int32_t,
    ...
    /* INT64 */
    {
        ...
        .round_func      = NULL,
        .abs_func        = NULL,
        .sqrt_func       = ort_math_frontend_sqrt_int64_t,
    ...
    /* UINT8 */
    {
        ...
        .round_func      = NULL,
        .abs_func        = NULL,
        .sqrt_func       = ort_math_frontend_sqrt_uint8_t,
        ...
        .sum_func        = ort_math_frontend_sum_uint8_t,
        .sum_axis_func   = ort_math_frontend_sum_axis_uint8_t,
    ...
    /* UINT16 */
    {
        ...
        .round_func      = NULL,
        .abs_func        = NULL,
        .sqrt_func       = ort_math_frontend_sqrt_uint16_t,
        ...
        .sum_func        = ort_math_frontend_sum_uint16_t,
        .sum_axis_func   = ort_math_frontend_sum_axis_uint16_t,
    ...
    /* UINT32 */
    {
        ...
        .round_func      = NULL,
        .abs_func        = NULL,
        .sqrt_func       = ort_math_frontend_sqrt_uint32_t,
        ...
        .sum_func        = ort_math_frontend_sum_uint32_t,
        .sum_axis_func   = ort_math_frontend_sum_axis_uint32_t,
    ...
    /* BOOL */
    {
        ...
        .dot_func        = NULL,
        .matmul_func     = NULL,
        .sum_func        = ort_math_frontend_sum_zend_bool,
        .sum_axis_func   = ort_math_frontend_sum_axis_zend_bool,
