/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_ARCCOS
#define HAVE_ORT_MATHS_SCHEMA_ARCCOS

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f arccos -n arccos -u
/* }}} */
static const ONNXTensorElementDataType ort_math_promotion_schema_table_arccos[11] = {
...
static const ONNXTensorElementDataType ort_math_promotion_schema_indices_arccos[11] = {
...
static const ort_math_promotion_schema_t ort_math_promotion_schema_arccos = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_arccos,
    .indices = ort_math_promotion_schema_indices_arccos,
    .size    = 11
};
