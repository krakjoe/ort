/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_ARCTAN
#define HAVE_ORT_MATHS_SCHEMA_ARCTAN

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f arctan -n arctan -u
/* }}} */
...
static const ort_math_promotion_schema_t ort_math_promotion_schema_arctan = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_arctan,
    .indices = ort_math_promotion_schema_indices_arctan,
    .size    = 11
};
