...
static const ONNXTensorElementDataType ort_math_promotion_schema_table_pow[11*11] = {
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// pow(float16, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float16, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float16, float64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// pow(float16, int8) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float16, int16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float16, int32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float16, int64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// pow(float16, uint8) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float16, uint16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float16, uint32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// pow(float16, bool) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float32, float16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float32, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float32, float64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float32, int8) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float32, int16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float32, int32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float32, int64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float32, uint8) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float32, uint16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float32, uint32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(float32, bool) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, float64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, int8) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, int16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, int32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, int64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, uint8) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, uint16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, uint32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(float64, bool) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// pow(int8, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(int8, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int8, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(int16, float16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(int16, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int16, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int32, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int32, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int32, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int64, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int64, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(int64, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// pow(uint8, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(uint8, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(uint8, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(uint16, float16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(uint16, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(uint16, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(uint32, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(uint32, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(uint32, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// pow(bool, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// pow(bool, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// pow(bool, float64) -> float64
