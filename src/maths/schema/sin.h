/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_SIN
#define HAVE_ORT_MATHS_SCHEMA_SIN

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f sin -n sin -u
/* }}} */
static const ONNXTensorElementDataType ort_math_promotion_schema_table_sin[11] = {
...
static const ONNXTensorElementDataType ort_math_promotion_schema_indices_sin[11] = {
...
static const ort_math_type_promotion_schema_t ort_math_promotion_schema_sin = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_sin,
    .indices = ort_math_promotion_schema_indices_sin,
    .size    = 11
};
