...
static const ONNXTensorElementDataType ort_math_promotion_schema_table_ceil[11] = {
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_INT64,	// ceil(int64) -> int64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT8,	// ceil(uint8) -> uint8
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT16,	// ceil(uint16) -> uint16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT32,	// ceil(uint32) -> uint32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_BOOL,	// ceil(bool) -> bool
};
