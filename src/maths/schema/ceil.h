/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_CEIL
#define HAVE_ORT_MATHS_SCHEMA_CEIL

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f ceil -n ceil -u
/* }}} */
...
static const ort_math_type_promotion_schema_t ort_math_promotion_schema_ceil = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_ceil,
    .indices = ort_math_promotion_schema_indices_ceil,
    .size    = 11
};
