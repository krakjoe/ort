/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_LOG10
#define HAVE_ORT_MATHS_SCHEMA_LOG10

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f log10 -n log10 -u
/* }}} */
static const ONNXTensorElementDataType ort_math_promotion_schema_table_log10[11] = {
...
static const ONNXTensorElementDataType ort_math_promotion_schema_indices_log10[11] = {
...
static const ort_math_type_promotion_schema_t ort_math_promotion_schema_log10 = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_log10,
    .indices = ort_math_promotion_schema_indices_log10,
    .size    = 11
};
