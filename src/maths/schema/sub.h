...
static const ONNXTensorElementDataType ort_math_promotion_schema_table_sub[11*11] = {
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// sub(float16, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float16, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float16, float64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// sub(float16, int8) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float16, int16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float16, int32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float16, int64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// sub(float16, uint8) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float16, uint16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float16, uint32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// sub(float16, bool) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float32, float16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float32, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float32, float64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float32, int8) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float32, int16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float32, int32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float32, int64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float32, uint8) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float32, uint16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float32, uint32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(float32, bool) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, float64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, int8) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, int16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, int32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, int64) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, uint8) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, uint16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, uint32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(float64, bool) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// sub(int8, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(int8, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int8, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(int16, float16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(int16, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int16, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int32, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int32, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int32, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int64, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int64, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(int64, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// sub(uint8, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(uint8, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(uint8, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(uint16, float16) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(uint16, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(uint16, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(uint32, float16) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(uint32, float32) -> float64
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(uint32, float64) -> float64
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16,	// sub(bool, float16) -> float16
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32,	// sub(bool, float32) -> float32
    ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64,	// sub(bool, float64) -> float64
