/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_EXP2
#define HAVE_ORT_MATHS_SCHEMA_EXP2

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f exp2 -n exp2 -u
/* }}} */
static const ONNXTensorElementDataType ort_math_promotion_schema_table_exp2[11] = {
...
static const ONNXTensorElementDataType ort_math_promotion_schema_indices_exp2[11] = {
