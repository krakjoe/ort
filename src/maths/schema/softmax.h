...
static const ONNXTensorElementDataType ort_math_promotion_schema_table_softmax[11] = {
    ...
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UNDEFINED,	// softmax(int64) -> UNDEFINED
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UNDEFINED,	// softmax(uint8) -> UNDEFINED
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UNDEFINED,	// softmax(uint16) -> UNDEFINED
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UNDEFINED,	// softmax(uint32) -> UNDEFINED
    ONNX_TENSOR_ELEMENT_DATA_TYPE_UNDEFINED,	// softmax(bool) -> UNDEFINED
};
