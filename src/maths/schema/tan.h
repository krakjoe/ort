/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_TAN
#define HAVE_ORT_MATHS_SCHEMA_TAN

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f tan -n tan -u
/* }}} */
static const ONNXTensorElementDataType ort_math_promotion_schema_table_tan[11] = {
...
static const ONNXTensorElementDataType ort_math_promotion_schema_indices_tan[11] = {
...
static const ort_math_type_promotion_schema_t ort_math_promotion_schema_tan = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_tan,
    .indices = ort_math_promotion_schema_indices_tan,
    .size    = 11
};
