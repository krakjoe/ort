/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_FLOOR
#define HAVE_ORT_MATHS_SCHEMA_FLOOR

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f floor -n floor -u
/* }}} */
static const ONNXTensorElementDataType ort_math_promotion_schema_table_floor[11] = {
...
static const ONNXTensorElementDataType ort_math_promotion_schema_indices_floor[11] = {
...
static const ort_math_type_promotion_schema_t ort_math_promotion_schema_floor = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_floor,
    .indices = ort_math_promotion_schema_indices_floor,
    .size    = 11
};
