/*
  ...
  +----------------------------------------------------------------------+
 */
#ifndef HAVE_ORT_MATHS_SCHEMA_TANH
#define HAVE_ORT_MATHS_SCHEMA_TANH

#include "maths/promotion.h"

/* {{{ 
@extract python3 tests/fixtures/extract.py -f tanh -n tanh -u
/* }}} */
static const ONNXTensorElementDataType ort_math_promotion_schema_table_tanh[11] = {
...
static const ONNXTensorElementDataType ort_math_promotion_schema_indices_tanh[11] = {
...
static const ort_math_type_promotion_schema_t ort_math_promotion_schema_tanh = {
    .kind    = ORT_MATH_TYPE_PROMOTION_SCHEMA_UNARY,
    .table   = ort_math_promotion_schema_table_tanh,
    .indices = ort_math_promotion_schema_indices_tanh,
    .size    = 11
};
