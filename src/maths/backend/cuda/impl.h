...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, dot, float16);
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mod, float16);
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mod, float32);
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mod, float64);
...
ORT_MATH_BACKEND_UNARY_OP_DECL(cuda, round, float16);
