...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mul, float16) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(mul, FLOAT16)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mul, float32) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(mul, FLOAT32)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mul, float64) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(mul, FLOAT64)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mul, int16_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(mul, INT16)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mul, int32_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(mul, INT32)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mul, uint16_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(mul, UINT16)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, mul, uint32_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(mul, UINT32)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
