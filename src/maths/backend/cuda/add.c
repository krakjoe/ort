...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, float16) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, FLOAT16)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, float32) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, FLOAT32)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, float64) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, FLOAT64)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, int8_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, INT8)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, int16_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, INT16)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, int32_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, INT32)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, int64_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, INT64)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, uint8_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, UINT8)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, uint16_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, UINT16)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
...
ORT_MATH_BACKEND_BINARY_OP_DECL(cuda, add, uint32_t) {
    ...
    if (cudaGetLastError() != cudaSuccess) {
        /* LCOV_EXCL_START */
        ORT_MATH_BACKEND_RELAY_CPU_BINARY(add, UINT32)
            (res, va, vb, count);
        return;
        /* LCOV_EXCL_STOP */
    }
