...
void ort_math_backend_cpu_install(ort_math_dispatch_t* table) {
    ...
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, abs, float16)
#endif
    ...
    /* add.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, add, float16)
#endif
    ...
    /* ceil.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, ceil, float16)
#endif
    ...
    /* div.c*/
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, div, float16)
#endif
    ...
    /* dot.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, dot, float16)
#endif
    ...
    /* floor.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, floor, float16)
#endif
    ...
    /* matmul.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, matmul, float16)
#endif
    ...
    /* mul.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, mul, float16)
#endif
    ...
    /* neg.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, neg, float16)
#endif
    ...
    /* recip.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, recip, float16)
#endif
    ...
    /* round.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, round, float16)
#endif
    ...
    /* sign.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, sign, float16)
#endif
    ...
    /* sqrt.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, sqrt, float16)
#endif
    ...
    /* sub.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, sub, float16)
#endif
    ...
    /* trunc.c */
#ifdef ORT_BACKEND_CPU_F16C
    ORT_MATH_BACKEND_INSTALL(table, avx512, FLOAT16, trunc, float16)
#endif
