...
ORT_MATH_BACKEND_UNARY_OP_DECL(neg, int8_t) {
...
ORT_MATH_BACKEND_UNARY_OP_DECL(neg, int16_t) {
...
ORT_MATH_BACKEND_UNARY_OP_DECL(neg, int32_t) {
...
ORT_MATH_BACKEND_UNARY_OP_DECL(neg, int64_t) {
