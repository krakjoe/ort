...
void ort_math_backend_install(ort_math_dispatch_t* table) {
    ...
    ORT_MATH_DISPATCH_INSTALL(table, INT64,   add, ort_math_backend_add_int64_t);
    ...
    /* ceil.c */
    ORT_MATH_DISPATCH_INSTALL(table, FLOAT,   ceil, ort_math_backend_ceil_float);
    ORT_MATH_DISPATCH_INSTALL(table, DOUBLE,  ceil, ort_math_backend_ceil_double);
    ...
    /* floor.c */
    ORT_MATH_DISPATCH_INSTALL(table, FLOAT,   floor, ort_math_backend_floor_float);
    ORT_MATH_DISPATCH_INSTALL(table, DOUBLE,  floor, ort_math_backend_floor_double);
    ...
    ORT_MATH_DISPATCH_INSTALL(table, INT32,   matmul, ort_math_backend_matmul_int32_t);
    ORT_MATH_DISPATCH_INSTALL(table, UINT16,  matmul, ort_math_backend_matmul_uint16_t);
    ORT_MATH_DISPATCH_INSTALL(table, UINT32,  matmul, ort_math_backend_matmul_uint32_t);
    ORT_MATH_DISPATCH_INSTALL(table, INT8,    matmul, ort_math_backend_matmul_int8_t);
    ORT_MATH_DISPATCH_INSTALL(table, UINT8,   matmul, ort_math_backend_matmul_uint8_t);
    ...
    ORT_MATH_DISPATCH_INSTALL(table, INT32,   mul, ort_math_backend_mul_int32_t);
    ORT_MATH_DISPATCH_INSTALL(table, UINT16,  mul, ort_math_backend_mul_uint16_t);
    ORT_MATH_DISPATCH_INSTALL(table, UINT32,  mul, ort_math_backend_mul_uint32_t);
    ...
    /* round.c */
    ORT_MATH_DISPATCH_INSTALL(table, FLOAT,   round, ort_math_backend_round_float);
    ORT_MATH_DISPATCH_INSTALL(table, DOUBLE,  round, ort_math_backend_round_double);
