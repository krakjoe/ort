...
ort_math_result_t* ort_math_result_pow(ort_tensor_t* tensor_a, ort_tensor_t* tensor_b);
ort_math_result_t* ort_math_result_mod(ort_tensor_t* tensor_a, ort_tensor_t* tensor_b);
...
ort_math_result_t* ort_math_result_pow_scalar(ort_tensor_t* tensor, zval* scalar);
ort_math_result_t* ort_math_result_mod_scalar(ort_tensor_t* tensor, zval* scalar);
