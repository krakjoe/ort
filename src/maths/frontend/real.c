...
ORT_MATH_UNARY_RESULT_IMPL(sin, ort_math_frontend_get_sin_func, &ort_math_promotion_schema_sin)
ORT_MATH_UNARY_RESULT_IMPL(cos, ort_math_frontend_get_cos_func, &ort_math_promotion_schema_cos)
ORT_MATH_UNARY_RESULT_IMPL(tan, ort_math_frontend_get_tan_func, &ort_math_promotion_schema_tan)
ORT_MATH_UNARY_RESULT_IMPL(asin, ort_math_frontend_get_asin_func, &ort_math_promotion_schema_asin)
ORT_MATH_UNARY_RESULT_IMPL(acos, ort_math_frontend_get_acos_func, &ort_math_promotion_schema_acos)
ORT_MATH_UNARY_RESULT_IMPL(atan, ort_math_frontend_get_atan_func, &ort_math_promotion_schema_atan)
ORT_MATH_UNARY_RESULT_IMPL(sinh, ort_math_frontend_get_sinh_func, &ort_math_promotion_schema_sinh)
ORT_MATH_UNARY_RESULT_IMPL(cosh, ort_math_frontend_get_cosh_func, &ort_math_promotion_schema_cosh)
ORT_MATH_UNARY_RESULT_IMPL(tanh, ort_math_frontend_get_tanh_func, &ort_math_promotion_schema_tanh)
ORT_MATH_UNARY_RESULT_IMPL(exp, ort_math_frontend_get_exp_func, &ort_math_promotion_schema_exp)
ORT_MATH_UNARY_RESULT_IMPL(exp2, ort_math_frontend_get_exp2_func, &ort_math_promotion_schema_exp2)
ORT_MATH_UNARY_RESULT_IMPL(log, ort_math_frontend_get_log_func, &ort_math_promotion_schema_log)
ORT_MATH_UNARY_RESULT_IMPL(log2, ort_math_frontend_get_log2_func, &ort_math_promotion_schema_log2)
ORT_MATH_UNARY_RESULT_IMPL(log10, ort_math_frontend_get_log10_func, &ort_math_promotion_schema_log10)
ORT_MATH_UNARY_RESULT_IMPL(cbrt, ort_math_frontend_get_cbrt_func, &ort_math_promotion_schema_cbrt)

ORT_MATH_UNARY_RESULT_IMPL(abs, ort_math_frontend_get_abs_func, &ort_math_promotion_schema_abs)
ORT_MATH_UNARY_RESULT_IMPL(ceil, ort_math_frontend_get_ceil_func, &ort_math_promotion_schema_ceil)
ORT_MATH_UNARY_RESULT_IMPL(floor, ort_math_frontend_get_floor_func,&ort_math_promotion_schema_floor)
ORT_MATH_UNARY_RESULT_IMPL(round, ort_math_frontend_get_round_func, &ort_math_promotion_schema_round)
ORT_MATH_UNARY_RESULT_IMPL(trunc, ort_math_frontend_get_trunc_func, &ort_math_promotion_schema_trunc)