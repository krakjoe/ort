...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_ADD_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_ADD_SCALAR_OP_DECL)
...
ORT_MATH_FOREACH_NUMERIC_TYPE(ORT_MATH_FRONTEND_SUB_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_SUB_OP_DECL)
#undef ORT_MATH_FRONTEND_SUB_OP_DECL /* }}} */

/* {{{ Frontend Forward Declarations of Scalar Subtraction Operations */
#define ORT_MATH_FRONTEND_SUB_SCALAR_OP_DECL(type, unused) \
        ORT_MATH_FRONTEND_SCALAR_OP_DECL(sub, type);
ORT_MATH_FOREACH_NUMERIC_TYPE(ORT_MATH_FRONTEND_SUB_SCALAR_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_SUB_SCALAR_OP_DECL)
#undef ORT_MATH_FRONTEND_SUB_SCALAR_OP_DECL /* }}} */
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_MUL_OP_DECL)
#undef ORT_MATH_FRONTEND_MUL_OP_DECL /* }}} */

/* {{{ Frontend Forward Declarations of Scalar Multiplication Operations */
#define ORT_MATH_FRONTEND_MUL_SCALAR_OP_DECL(type, unused) \
        ORT_MATH_FRONTEND_SCALAR_OP_DECL(mul, type);
ORT_MATH_FOREACH_ALL_TYPES(ORT_MATH_FRONTEND_MUL_SCALAR_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_MUL_SCALAR_OP_DECL)
#undef ORT_MATH_FRONTEND_MUL_OP_DECL /* }}} */
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_DIV_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_DIV_SCALAR_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_SQRT_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_CEIL_OP_DECL)
...
ORT_MATH_FOREACH_NUMERIC_TYPE(ORT_MATH_FRONTEND_FLOOR_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_FLOOR_OP_DECL)
...
ORT_MATH_FOREACH_NUMERIC_TYPE(ORT_MATH_FRONTEND_ROUND_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_ROUND_OP_DECL)
...
ORT_MATH_FOREACH_NUMERIC_TYPE(ORT_MATH_FRONTEND_TRUNC_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_TRUNC_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_ABS_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_NEG_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_RECIP_OP_DECL)
...
ORT_MATH_FOREACH_NUMERIC_TYPE(ORT_MATH_FRONTEND_SIGN_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_SIGN_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_MOD_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_MOD_SCALAR_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_POW_OP_DECL)
#undef ORT_MATH_FRONTEND_POW_OP_DECL /* }}} */

/* {{{ Frontend Forward Declarations of Scalar Power Operations */
#define ORT_MATH_FRONTEND_POW_SCALAR_OP_DECL(type, unused) \
        ORT_MATH_FRONTEND_SCALAR_OP_DECL(pow, type);
ORT_MATH_FOREACH_NUMERIC_TYPE(ORT_MATH_FRONTEND_POW_SCALAR_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_POW_SCALAR_OP_DECL)
#undef ORT_MATH_FRONTEND_POW_SCALAR_OP_DECL /* }}} */
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_DOT_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(_ORT_MATH_FRONTEND_MATMUL_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_MIN_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(_ORT_MATH_FRONTEND_MAX_OP_DECL)
...
#define ORT_MATH_FRONTEND_SOFTMAX_OP_DECL(type, unused) \
        ORT_MATH_FRONTEND_TRANSFORMATION_AXIS_OP_DECL(softmax, type);
ORT_MATH_FOREACH_REAL_TYPE(ORT_MATH_FRONTEND_SOFTMAX_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_SOFTMAX_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_ARGMAX_OP_DECL)
#undef ORT_MATH_FRONTEND_ARGMAX_OP_DECL /* }}} */

/* {{{ Frontend Forward Declarations of Argmin Operations */
#define ORT_MATH_FRONTEND_ARGMIN_OP_DECL(type, unused) \
        ORT_MATH_FRONTEND_REDUCTION_OP_DECL(argmin, type); \
        ORT_MATH_FRONTEND_REDUCTION_AXIS_OP_DECL(argmin, type);
ORT_MATH_FOREACH_ALL_TYPES(ORT_MATH_FRONTEND_ARGMIN_OP_DECL)
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_ARGMIN_OP_DECL)
#undef ORT_MATH_FRONTEND_ARGMIN_OP_DECL /* }}} */
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_MEAN_OP_DECL)
...
ORT_MATH_FOREACH_CUSTOM_TYPE(ORT_MATH_FRONTEND_SUM_OP_DECL)
