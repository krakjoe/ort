...
void ort_math_simd_matmul_float(
    void *result,
    ...
    size_t a_rows, size_t a_cols, size_t b_cols)
{
    ...
    for (size_t i = 0; i < a_rows; i++) {
        for (size_t j = 0; j < b_cols; j++) {
            ...
            float sum = 0.0f;
            const size_t mw = 8;
            size_t mc = ort_math_simd_optimal_count(a_cols, mw);
            size_t k = 0;
            for (; k < mc; k += mw) {
...
void ort_math_simd_matmul_double(
    void *result,
    const void *a, const void *b,
    size_t a_rows, size_t a_cols, size_t b_cols)
{
...
void ort_math_simd_matmul_int32_t(
    void *result,
    const void *a, const void *b,
    size_t a_rows, size_t a_cols, size_t b_cols)
{
...
void ort_math_simd_matmul_uint32_t(
    void *result,
    const void *a, const void *b,
    size_t a_rows, size_t a_cols, size_t b_cols)
{
...
void ort_math_simd_matmul_int16_t(
    void *result,
    const void *a, const void *b,
    size_t a_rows, size_t a_cols, size_t b_cols)
{
...
void ort_math_simd_matmul_uint16_t(
    void *result,
    const void *a, const void *b,
    size_t a_rows, size_t a_cols, size_t b_cols)
{
...
void ort_math_simd_matmul_int8_t(
    void *result,
    const void *a, const void *b,
    size_t a_rows, size_t a_cols, size_t b_cols)
{
...
void ort_math_simd_matmul_uint8_t(
    void *result,
    const void *a, const void *b,
    size_t a_rows, size_t a_cols, size_t b_cols)
{
