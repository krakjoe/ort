...
# define ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT32 ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT
# define ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT64 ONNX_TENSOR_ELEMENT_DATA_TYPE_DOUBLE
#else
typedef enum {
